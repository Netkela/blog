...
> [!warning]
> Wondering why Mermaid diagrams may not be showing up even if you have them enabled? You may need to reorder your plugins so that [[../plugins/ObsidianFlavoredMarkdown]] is _after_ [[../plugins/SyntaxHighlighting]].
