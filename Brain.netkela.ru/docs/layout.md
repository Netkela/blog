...
See [a list of all the components](tags/component.md) for all available components along with their configuration options. Additionally, Quartz provides several built-in higher-order components for layout composition - see [[layout-components]] for more details.

You can also checkout the guide on [[advanced/creating components]] if you're interested in further customizing the behaviour of Quartz.
